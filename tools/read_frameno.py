...
P/S/D/R/C/W/M/A はlow byteの16進2桁で、間隔なしの連続32セル。
...
def read_hud(img):
    """Read every field from the current contiguous 32-cell DEBUG HUD."""
    gray = _gray(img)
    x0, y, fconf = _calib_origin(gray, HUD_CELLS * CELL)
    out = {}
